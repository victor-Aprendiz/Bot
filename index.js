...
const BotName = '⚡SUPER VICTOR CRACK⚡'; 
...
async function starts() {
	...
	client.on('open', () => {
		success('2', 'Conectado victor crak')
	})
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: 'ESTE PEDIDO É ESPECÍFICO PARA O MODERADOR DO ⚡SUPER VICTOR CRACK⚡*',
					...
					Badmin: 'Este comando so pode ser usado quando o ⚡SUPER VICTOR CRACK⚡ se torna ADM do grupo parsa',
				}
			}

			const botNumber = client.user.jid
			const ownerNumber = ["558981210976@s.whatsapp.net","5524816999@s.whatsapp.net","5524816999@s.whatsapp.net"] // Recoloque o seu numero
			...
			const adminbotnumber = ["558981210976@s.whatsapp.net","558981246187@s.whatsapp.net","5524816999@s.whatsapp.net"]// admin bot numero
			const frendsowner = ["558981210976@s.whatsapp.net","558981246187@s.whatsapp.net","5524816999@s.whatsapp.net"]// amigo do criador 
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
	...
	if (messagesC.includes("xandao")){
			...
			switch(command) {
				...
				reply(`${pushname} esse e o link da git do ⚡Super VICTORÕR⚡`)
				}, 1000)
					break
				case 'install':
			reply(`Aqui os comandos do ⚡Super VICTORÕR⚡ ${pushname}`)
			setTimeout( () => {
			client.sendMessage(from, Presence.composing)
